      ...
      <div className="container mx-auto">
        ...
        <div className="w-full flex flex-col items-center">
          <div className="w-full overflow-x-auto hide-scrollbar whitespace-nowrap scrollbar-hide">
            <div className="flex gap-6 justify-center border-b border-gray-300 relative">
              {PROPERTY_TYPES.map((tab) => (
                <button
                  key={tab}
                  className={`pb-2 transition-all min-w-[100px] max-w-[100px] rounded-md ${
                    activeTab === tab
                      ? "text-emerald-600 shadow-lg shadow-emerald-300"
                      : "text-gray-500 hover:text-emerald-500 hover:shadow-lg hover:shadow-emerald-300"
                  }`}
