...
const properties = [
    { id: 'featured-1', title: "Luxury Villa", status: "sale", price: "KWD 1,200,000", image: "images/villa.jpg", location: "hawally", beds: 4, baths: 3, area: "3500 sqft", agent: { name: "John Doe", logo: "images/agent1.jpg" } },
    { id: 'featured-2', title: "Modern Apartment", status: "rent", price: "KWD 800,000", image: "images/apartment.jpg", location: "jabriya", beds: 3, baths: 2, area: "2000 sqft", agent: { name: "Jane Smith", logo: "images/agent2.jpg" } },
    { id: 'featured-3', title: "Cozy House", status: "sale", price: "KWD 500,000", image: "images/house.jpg", location: "salmiya", beds: 2, baths: 1, area: "1500 sqft", agent: { name: "Alice Johnson", logo: "images/agent2.jpg" } },
];
        ...
        <div className="grid grid-cols-3 gap-6 mt-6">
          {properties.map((property) => (
            <div key={property.id} className="border rounded-lg shadow-md bg-zinc-200 relative overflow-hidden ">
              <div className={`absolute top-2 left-2 px-3 py-1 rounded-full text-white ${property.status === "sale" ? "bg-emerald-600 border border-zinc-400 opacity-90" : "bg-indigo-600 border border-zinc-400 opacity-90"}`}>
              ...
              <div className="mt-0 flex justify-between border-t border-gray-300 pt-4">
                <div className="flex space-x-4">
                  <button className="border border-emerald-600 text-gray-500 px-4 py-2 rounded-md flex items-center ml-1">
                    <Image src="/Images/phone-icon.png" alt="Phone" width={22} height={22} className="mr-2" />
                    Call
                  </button>
                  <button className="border border-emerald-600 text-gray-500 px-4 py-2 rounded-md flex items-center">
                    <Image src="/Images/Whatsapp-logo.png" alt="Whatsapp" width={24} height={24} className="mr-1" />
                    WhatsApp
                  </button>
                </div>
                <div className="flex space-x-4">
                  ...
                  <button className="border border-emerald-600 text-gray-500 px-4 py-2 rounded-md flex items-center mr-1">
