...
const PropertyCard = ({ property, cardType, selectedView }) => {
  ...
  return (
    <div
      key={property?._id}
      className="border rounded-lg bg-white shadow-md hover:shadow-xl cursor-pointer transition-all duration-300 hover:scale-[1.02] relative overflow-hidden "
      onClick={() => {
          ...
          {cardType === "UserlistingCard" ? (
            <>
              <div className="flex gap-2 w-full">
                <button
                  className="text-white px-4 py-2 rounded-md flex items-center bg-green-600 backdrop-blur text-sm font-semibold w-full grow"
                  onClick={() => {
            ...
            <>
              <div className="flex gap-2 w-full">
                <button className="text-white px-4 py-2 rounded-md flex items-center bg-green-600 backdrop-blur text-sm font-semibold w-full grow">
