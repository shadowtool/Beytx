  ...
  return (
    <footer className="bg-gray-900 text-white border-t border-gray-700">
      ...
      <div className="text-center py-4 text-sm">
        <a href="/properties/villas" className="mx-3 hover:text-green-400 transition duration-300">Villas</a>
        <a href="/properties/apartments" className="mx-3 hover:text-green-400 transition duration-300">Apartments</a>
        <a href="/properties/land" className="mx-3 hover:text-green-400 transition duration-300">Land</a>
      </div>
        {/* </div> */}
        {/* Internal Links */}
